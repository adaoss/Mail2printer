...
""")
    ...
    def test_image_to_pdf_landscape_orientation(self, mock_image):
        """Test that landscape images get landscape orientation"""
        ...
        with patch('tempfile.NamedTemporaryFile') as mock_temp:
            ...
            # Should set landscape orientation
            self.assertEqual(self.printer_manager._last_image_orientation, 'landscape')
    ...
    def test_image_scaling_calculation(self, mock_image):
        """Test that images are properly scaled to fit A4"""
        ...
        with patch('tempfile.NamedTemporaryFile') as mock_temp:
            ...
            # Should use landscape orientation for wide image
            self.assertEqual(self.printer_manager._last_image_orientation, 'landscape')
    ...
    def test_image_to_pdf_very_large_image_no_margins(self, mock_image):
        """Test that very large images fall back to no margins"""
        ...
        with patch('tempfile.NamedTemporaryFile') as mock_temp:
            ...
            # Should use landscape for wide image
            self.assertEqual(self.printer_manager._last_image_orientation, 'landscape')
